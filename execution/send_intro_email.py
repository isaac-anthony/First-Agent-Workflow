...
def send_brine_intro_email(lead_email: str, lead_name: str, business_name: str, niche: str = "business"):
    """
    Sends the professional Brine.ai introduction email.
    """
...
I noticed {business_name} while looking at successful businesses in the {niche} space.
